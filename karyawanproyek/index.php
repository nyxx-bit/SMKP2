            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    <div class="col"><button
                            ...
                            data-target="#addemployee">Add Project<i class="fas fa-plus-circle edit-icon"></i></button>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="col-md-6">
                                    <form method="POST" action="addkaryawanproyek.php">
                                        <input type="text" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Nama Proyek"
                                            name="nama_proyek" />
                                        ...
                                        <input type="date" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Tenggat Waktu"
                                            name="tenggat_waktu" />
                                        <input type="text" class="border rounded-0 form-control"
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <?php 
                                        if(isset($_GET['search'])){
                                            $cari = $_GET['search'];
                                            $tampil = mysqli_query($mysqli, "select * from karyawanproyek where nama_proyek like '%".$cari."%'"); 
                                        }
                                        else{
                                            $tampil = mysqli_query($mysqli, "select * from karyawanproyek"); 
                                        }
                                        ...
                                        <div class="modal fade" id="edit<?=$data['karyawan_id']?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col-md-6">
                                                            <form method="POST" action="editkaryawanproyek.php">
                                                                <input type="hidden"
                                                                ...
                                                                <input type="text" class="border rounded-0 form-control"
                                                                    style="width: 440px;margin-bottom: 15px;"
                                                                    placeholder="Nama Proyek" name="nama_proyek"
                                                                ...
                                                                <input type="date" class="border rounded-0 form-control"
                                                                    style="width: 440px;margin-bottom: 15px;"
                                                                    placeholder="Tenggat Waktu" name="tenggat_waktu"
                                        ...
                                        <div class="modal fade" id="deletemas<?=$data['karyawan_id']?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col-md-6">
                                                            <form method="POST" action="deletekaryawanproyek.php">
                                                                <input type="hidden"
                                                                    class="border rounded-0 form-control"
                                                                    style="width: 440px;margin-bottom: 15px;"
                                                                    placeholder="Id" name="karyawan_id"
