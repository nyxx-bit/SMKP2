        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li role="presentation" class="nav-item"><a class="nav-link" href="karyawancuti/"><i
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="col-md-6">
                                    <form method="POST" action="karyawan/addemployee.php">
                                        <input type="text" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Nama"
                                            name="nama_lengkap" />
                                        <input type="text" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Telepon"
                                            name="telp" />
                                        <input type="text" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Asal" name="asal" />
                                        <input type="date" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Kontrak"
                                            name="kontrak" />
                                        <input type="text" class="border rounded-0 form-control" placeholder="Jabatan"
                                            style="margin-bottom: 15px;width: 440px;" name="nama_jabatan" />
                                        <input type="text" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Gaji Pokok"
                                            name="gaji_pokok" />
                                        <input type="text" class="border rounded-0 form-control"
                                            style="width: 440px;margin-bottom: 15px;" placeholder="Tunjangan"
                                            name="tunjangan" />
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <?php 
                                        if(isset($_GET['search'])){
                                            $cari = $_GET['search'];
                                            $tampil = mysqli_query($mysqli, "select * from mykaryawan where nama_lengkap like '%".$cari."%'"); 
                                        }
                                        else{
                                            $tampil = mysqli_query($mysqli, "select * from mykaryawan"); 
                                        }
                                        ...
                                        <div class="modal fade" id="edit<?=$data['karyawan_id']?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col-md-6">
                                                            <form method="POST" action="karyawan/editemployee.php">
                                                                <input type="hidden"
                                                                ...
                                                                <input type="text" class="border rounded-0 form-control"
                                                                    style="width: 440px;margin-bottom: 15px;"
                                                                    placeholder="Asal" name="asal"
                                                                    value="<?=$data['asal']?>" />
                                                                <input type="date" class="border rounded-0 form-control"
                                                                    style="width: 440px;margin-bottom: 15px;"
                                                                    placeholder="Kontrak" name="kontrak"
                                                                    value="<?=$data['kontrak']?>" />
                                                                <input type="text" class="border rounded-0 form-control"
                                                                    placeholder="Jabatan"
                                                                ...
                                                                <input type="text" class="border rounded-0 form-control"
                                                                    style="width: 440px;margin-bottom: 15px;"
                                                                    placeholder="Tunjangan" name="tunjangan"
                                        ...
                                        <div class="modal fade" id="deletemas<?=$data['karyawan_id']?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col-md-6">
                                                            <form method="POST" action="karyawan/deleteemployee.php">
